...
Begin VB.Form frmRelFinanc2 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Resumo Financeiro 2 - Valores por Operação"
   ClientHeight    =   2685
   ClientLeft      =   1545
   ClientTop       =   2130
   ClientWidth     =   6690
   HelpContextID   =   1600
   Icon            =   "RelFinanc2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmRelFinanc2"
...
Private Sub B_Imprime_Click()
 ...
 If O_Sem.Value = True Then Str1 = gsReportPath & "FINANC2.RPT"
 If O_Com.Value = True Then Str1 = gsReportPath & "FINANC2S.RPT"
 ...
 Str_Rel = Str_Rel + " And {Resumo Diário.Data} >="
 Str_Rel = Str_Rel + Str_Data1
 Str_Rel = Str_Rel + " And {Resumo Diário.Data} <=" + Str_Data2
