...
Begin VB.Form frmApagaAcertoEmpEntrada 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Apaga Acerto de Empréstimos de Entrada"
   ClientHeight    =   2250
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7020
   Icon            =   "frmApagaAcertoEmpEntrada.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmApagaAcertoEmpEntrada"
...
Private Sub B_Apaga_Click()
  ...
  strSQL = "DELETE * FROM [Consignação Entrada] WHERE Filial = " & gnCodFilial & _
