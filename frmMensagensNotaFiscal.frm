...
Begin VB.Form frmMensagensNotaFiscal 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mensagens para Nota Fiscal"
   ClientHeight    =   6135
   ClientLeft      =   45
   ClientTop       =   360
   ClientWidth     =   10095
   Icon            =   "frmMensagensNotaFiscal.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.PictureBox picTitle 
      ...
      Begin VB.Label lblTitleDescription 
         ...
         Caption         =   "Adicione as mensagens a serem utilizadas na impressão da Nota Fiscal de acordo com as regras estipuladas."
         Height          =   315
         Index           =   0
         Left            =   600
         TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "frmMensagensNotaFiscal"
...
'06/02/2006 - mpdea
'Link para o arquivo de ajuda
Private Sub cmdAjuda_Click()
  htmlhelp Me.hwnd, gsDefaultPath & "Ajuda\Mensagem Nota Fiscal.chm", 0, 0
End Sub
...
Private Sub cmdIncluir_Click()
  ...
  Set objMensagemNotaFiscal = frmMensagensIncluirRegra.GetMensagemNotaFiscal
  
  If Not objMensagemNotaFiscal Is Nothing Then
    'Atualiza a ordem de todas as mensagens para que
    'a mensagem atual seja a primeira da ordem
    db.Execute "UPDATE MensagensNotaFiscal SET Ordem = Ordem + 1;", dbFailOnError
    'Adiciona a nova mensagem
    objMensagemNotaFiscal.AddNew
  ...
  If bGridBeforeDelete() Then
    With grdMensagens
      ...
      For intX = 0 To (.SelBookmarks.Count - 1)
        ...
        db.Execute "DELETE FROM MensagensNotaFiscal WHERE Codigo = " & lngCodigo, dbFailOnError
      Next intX
    End With
    Cancel = False
  Else
