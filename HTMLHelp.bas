...
'  The following members are only valid if HHWIN_PROP_TRI_PANE is set
  ...
  pszIndex As Index            '  IN: Location of the index file
...
Public Function SetHTMLHelpStrings(ByVal intSelHelpFile As Integer) As String
  ...
  Select Case intSelHelpFile
    Case 1
      SetHTMLHelpStrings = gsHelpFileName
    Case 2
      SetHTMLHelpStrings = gsHelpConv
    Case 3
      '
    Case 4
      '
...
'''  htmlhelp hWnd, SetHTMLHelpStrings(intHelpFile) & ">" & strWindow, _
'''    HH_DISPLAY_TOC, 0

  ' Force the Help window to display the Contents file
  ' (*.hhc) in the left pane
  htmlhelp hWnd, App.Path & "\QuickStoreHelp\QuickStoreHelp.chm", HH_DISPLAY_TOC, 0
...
Public Sub HTMLHelpSearch(ByVal intHelpFile As Integer, _
  strWindow As String)
...
Public Sub HTMLShowTopicID(ByVal intHelpFile As Integer, _
  strWindow As String, lngTopicID As Long)
  
  ' Force the Help window to load a specific topic.
  ' The Help window will synchronize the Contents display automatically
  htmlhelp hWnd, SetHTMLHelpStrings(intHelpFile) & ">" & strWindow, _
    HH_DISPLAY_TOPIC, lngTopicID
...
Public Sub HTMLShowTopic(ByVal intHelpFile As Integer, _
  ...
  ' Force the Help window to load a specific topic.
  ' The Help window will synchronize the Contents display automatically
  htmlHelpTopic hWnd, SetHTMLHelpStrings(intHelpFile) & ">" & strWindow, _
    HH_DISPLAY_TOPIC, strTopic
  
End Sub

Public Sub HTMLHelpPopup(ByVal intHelpFile As Integer, _
  intTopic As Integer)
  
  ' Display pop-up text
  htmlhelp hWnd, SetHTMLHelpStrings(intHelpFile) & ">Main", _
    HH_HELP_CONTEXT, intTopic
