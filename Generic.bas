...
Public Const gsTITLE2 As String = "Title"
...
Public Sub UpdateStatus(pic As PictureBox, ByVal sngPercent As Single, Optional ByVal fBorderCase As Boolean = False)
    ...
    If sngPercent > 0 Then
        pic.Line (0, 0)-(pic.Width * sngPercent, pic.Height), pic = pic.ForeColor, BF
    Else
...
'                '
'                strProgramIconTitle = ReadIniFile(gstrSetupInfoFile, vGroup, gsTITLE2 & CStr(intIdx))
