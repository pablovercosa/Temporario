...
Begin VB.Form frmRelPagas2 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Contas Pagas por Data de Pagamento"
   ClientHeight    =   2460
   ClientLeft      =   1860
   ClientTop       =   2145
   ClientWidth     =   6135
   Icon            =   "RelPagas2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmRelPagas2"
