...
Begin VB.Form frmVendaRap2_CheckOut 
   BorderStyle     =   0  'None
   ...
   ClientWidth     =   11205
   HelpContextID   =   1230
   Icon            =   "frmVendaRap2_CheckOut.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ...
   Begin SSDataWidgets_B.SSDBCombo Número 
      Bindings        =   "frmVendaRap2_CheckOut.frx":058A
      Height          =   285
      Left            =   10110
      TabIndex        =   95
      Top             =   45
   ...
   Begin SSDataWidgets_B.SSDBDropDown DropDown1 
      Bindings        =   "frmVendaRap2_CheckOut.frx":05A6
      Height          =   1035
      Left            =   480
      TabIndex        =   92
      Top             =   1680
   ...
   Begin VB.Data Data6 
      ...
      ReadOnly        =   -1  'True
      RecordsetType   =   1  'Dynaset
      RecordSource    =   $"frmVendaRap2_CheckOut.frx":05BA
      Top             =   7890
      Visible         =   0   'False
      Width           =   1800
   End
   Begin SSDataWidgets_B.SSDBDropDown DropDown2 
      Bindings        =   "frmVendaRap2_CheckOut.frx":0653
      Height          =   1035
      Left            =   480
      TabIndex        =   91
      Top             =   1200
   ...
   Begin SSDataWidgets_B.SSDBCombo Combo_Preço 
      Bindings        =   "frmVendaRap2_CheckOut.frx":0667
      Height          =   285
      Left            =   4200
      Negotiate       =   -1  'True
      TabIndex        =   1
   ...
   Begin SSDataWidgets_B.SSDBCombo Combo_Vendedor 
      Bindings        =   "frmVendaRap2_CheckOut.frx":067B
      DataSource      =   "Data3"
      Height          =   285
      Left            =   6480
      TabIndex        =   2
   ...
   Begin VB.Frame Frame_Recebimento 
      ...
      Begin SSDataWidgets_B.SSDBCombo Combo_Cartão 
         Bindings        =   "frmVendaRap2_CheckOut.frx":068F
         DataSource      =   "Data4"
         Height          =   285
         Left            =   840
         TabIndex        =   9
   ...
   Begin VB.Data Data1 
      ...
      ReadOnly        =   -1  'True
      RecordsetType   =   1  'Dynaset
      RecordSource    =   $"frmVendaRap2_CheckOut.frx":06A3
      Top             =   7890
      Visible         =   0   'False
      Width           =   1815
   End
   ...
   Begin SSDataWidgets_B.SSDBCombo Combo_Cliente 
      Bindings        =   "frmVendaRap2_CheckOut.frx":0738
      DataSource      =   "Data1"
      Height          =   285
      Left            =   4200
      TabIndex        =   3
   ...
   Begin SSDataWidgets_B.SSDBCombo cboCaixa 
      Bindings        =   "frmVendaRap2_CheckOut.frx":074C
      Height          =   285
      Left            =   960
      TabIndex        =   0
      Top             =   360
   ...
   Begin ActiveBarLibraryCtl.ActiveBar ActiveBar1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Bands           =   "frmVendaRap2_CheckOut.frx":0763
   End
   ...
   End
End
Attribute VB_Name = "frmVendaRap2_CheckOut"
...
'  End If
  ...
  rsSaidas("Observações") = "Venda rápida"
...
Sub Mostra_Mov(ByVal Num As Long)
  ...
  '''L_Tot_Pagar.Text = Format(rsSaidas("Total") - rsSaidas("Desconto"), "###,###,##0.00")
...
'      B_Ticket.Top = 90
  ...
  datSequencias.RecordSource = " SELECT Sequência, Cliente, Referência, Total " & _
                               " FROM Saídas WHERE Filial = " & gnCodFilial & " AND Efetivada = False " & _
                               " AND Data = #" & Format(Data_Atual, "mm/dd/yyyy") & "#" & _
                               " ORDER BY Sequência DESC "
  ...
  '''Data5.RecordSource = "SELECT DISTINCT Tabela FROM Preços WHERE Tabela <> 'CUSTO' ORDER BY Tabela"
...
'  If rsParametros("VR Altera Preço") = False Then Grade1.Columns(3).Locked = True
 ...
 If rsParametros("VR Permite Rec Rápido") = False Then
...
Private Function GravarComanda()
  ...
  If (txtComanda.Text <> "") Then
    ...
    While Not rsComandas.EOF
      If (rsComandas("CodSaida") = Número.Text) Then
        rsComandas.Edit
...
On Error GoTo Erro
  ...
  rsComandas.MoveFirst
  While Not rsComandas.EOF
    If (rsComandas("CodSaida").Value = Número.Text) Then
