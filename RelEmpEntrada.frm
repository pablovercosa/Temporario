...
Begin VB.Form frmRelEmpEntrada 
   ...
   Caption         =   "Relatório de Empréstimos de Entrada"
   ClientHeight    =   3795
   ClientLeft      =   3570
   ClientTop       =   1965
   ClientWidth     =   7080
...
Private Sub B_Imprime_Click()
 ...
 Str_Rel = "{Consignação Entrada.Filial} =" + Combo_Filial.Text
 If Nome_Cliente.Caption <> "" Then
   Str_Rel = Str_Rel + " And {Consignação Entrada.Fornecedor} = " + Combo_Cliente.Text
 End If
 If Nome_Produto.Caption <> "" Then
   Str_Rel = Str_Rel + " And {Consignação Entrada.Produto} = '" + Combo_Produto.Text + "'"
 End If
